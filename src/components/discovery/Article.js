...
class Article extends React.Component {
    ...
    handleArticleClick(id,e){
        dispatch(routerRedux.push(`/article/${id}`));
    }

    render() {
        return (<div style={{ width:'100%',height: '100%',backgroundColor: '#fff' }}>
                   <WingBlank size="lg">
                     <List renderHeader={ () => (<div style={{align:'left',textAlign:'left',height:'40px',}} >
                                ...
                                <Item extra={<img src={require(`../../public/img/shop001.jpg`)} style={{ width:'100%',height: '80px'}}/>} multipleLine align="top" wrap>
                                    ...
                                    <a href='/article/1' onClick={this.handleArticleClick.bind('1')} > Read More </a></p>
                                </Item>
                      </List>
                    </WingBlank>
                    ...
                    <WingBlank size="lg">
                        <List renderHeader={ () => (<div style={{align:'left',textAlign:'left',height:'40px',}} >
                            <Badge text="精华" style={{ marginRight:'12px',padding: '0px 3px', backgroundColor: '#21b68a', borderRadius: 2 }} />
                            ...
                            <Item extra={<img src={require(`../../public/img/shop001.jpg`)} style={{ width:'100%',height: '80px'}}/>} multipleLine align="top" wrap>
                                ...
                                <a href='#/article/2'  onClick={this.handleArticleClick.bind('2')} > Read More </a></p>
                            </Item>
                        </List>
                    </WingBlank>
                    <WhiteSpace style={{ backgroundColor: '#dbcdcd' }}/>
